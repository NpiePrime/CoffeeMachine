...
public class CoffeeMakerScenarios {
	...
	private void testCheckInventoryBeforeUse() {
		String inv = "Coffee: 15\n" + 
				"Milk: 15\n" + 
				"Sugar: 15\n" + 
				"Chocolate: 15\n";
		assert(inv.equals(cm.checkInventory()));
		System.out.println("testCheckInventoryBeforeUse passed with success");
	}
	private void testMakingManyCoffeesRefillsIsStillPossible() {
		cm.addRecipe(r1);
		assertEquals(0, cm.makeCoffee(0, 50));
		assertEquals(0, cm.makeCoffee(0, 50));
		assertEquals(0, cm.makeCoffee(0, 50));
		...
		assertEquals(0, cm.makeCoffee(0, 50));
		assertEquals(50, cm.makeCoffee(0, 50));
		System.out.println("testMakingManyCoffeesRefillsIsStillPossible passed with success");
...
//		testScenario.testMakingManyCoffeesRefillsIsStillPossible();
